...
const VideoTitle = ({title,overview}) => {
  return (
    <div className='pt-40 px-12'>
        ...
        <div>
            <button className='bg-black bg-opacity-50 text-white px-8 py-3 text-xl rounded-lg'>
 ...
 Play</button>
            <button className='bg-gray-500 bg-opacity-50 text-white px-8 py-3 text-xl rounded-lg mx-2'>
